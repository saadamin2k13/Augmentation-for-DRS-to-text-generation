...
# to run experiment, python version should be 2.7
# use this command to run experiment use command below
# python sig-test.py word-simple-bleu.txt word-name-aug-bleu.txt 0.05

# to download a file from/ to server/mac use command below
#scp amin@130.192.212.29:~/files-for-sig-test/gold+silver-duplicate-experiment/word-output-of-duplicate-gold-silver-pmb.txt.raw /Users/muhammadsaadamin/PycharmProjects/Significance-Test

##### error reason #####
# python == 2.7 not 3.9 or any updated version